...
1. Reproduce a small worked example.
2. Modify one constraint.
3. Build a bounded artifact from a specification.
4. Debug a flawed artifact.
5. Build a final artifact without step-by-step instructions.
